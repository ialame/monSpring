...
public class JTableMagic extends JPanel{
    ...
    private class SaveAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                //((CarteMagic) modele.getCartes().get(0)).getExtensionMagic().save(com.pca.gui.ApplicationPM.getTable_ExtensionMagic());
        ...
        public void actionPerformed(ActionEvent e) {
            RowFilter<ModeleTableMagic,Integer> ageFilter = new RowFilter<ModeleTableMagic,Integer>() {
                public boolean include(Entry<? extends ModeleTableMagic, ? extends Integer> entry) {
                    ...
                    //c..setText(com.pca.gui.ApplicationPM.statusMagic[item]);
                    /*if(item>0 && carte.getStatus()==item+com.pca.gui.ApplicationPM.MAGIC) {
                        switch (item + com.pca.gui.ApplicationPM.MAGIC) {
                            case com.pca.gui.ApplicationPM.STATUS_MAGIC_SPLIT:
