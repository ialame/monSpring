...
import com.pca.entity.Extension;
...
public class ExtensionMagic extends Extension {
    ...
    void mySQL2ExtensionMagic(ResultSet  rs){
        /*try {
            Statement statementCarte = com.pca.gui.ApplicationPM.DB.getConnect().createStatement();
            ...
            *//*
                int idSerie = 0;
                String sql = "select * from "+ com.pca.gui.ApplicationPM.getTable_SerieMagic() + " where id  = " + serie_id ;
                ...
                if(idSerie==0)
                    serie.save(com.pca.gui.ApplicationPM.getTable_SerieMagic());
                this.setSerie(serie);
            *//*
            statementCarte = com.pca.gui.ApplicationPM.DB.getConnect().createStatement();
            String sql = "select * from "+ com.pca.gui.ApplicationPM.DB.getTable_CarteMagic() +" where extensionMagic_id  = " + id ;
...
*/
    ...
    void save(String tableExtension){
        ...
        /*try{
            Connection connection = com.pca.gui.ApplicationPM.DB.getConnect();
            Statement statement =connection.createStatement();
