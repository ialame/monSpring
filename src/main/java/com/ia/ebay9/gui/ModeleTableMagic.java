...
public class ModeleTableMagic extends AbstractTableModel implements TableModelListener{
    ...
    public boolean isCellEditable(int rowIndex, int columnIndex) {
        ...
        /*if(columnIndex==15) {
            if(c.getStatus()==com.ia.ebay9.gui.ApplicationPM.STATUS_CARTE_SANS_EXTENSION_US || c.getStatus()==com.ia.ebay9.gui.ApplicationPM.STATUS_CARTE_EXTENSION_US_INEXISTANTE) {
                return true;
            }else {
                return false;
            }
