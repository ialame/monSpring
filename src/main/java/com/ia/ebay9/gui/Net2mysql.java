...
import com.ia.ebay9.repository.CarteEbayRepository;
...
public class Net2mysql  implements Runnable{
    ...
    public Net2mysql(Ebay app) {
        ...
        try {
            ...
            //    MIGRATION
            seriesUS =(ArrayList<SerieUS>) com.ia.ebay9.gui.ApplicationPM.getSeriesUS();
            pokemons = (ArrayList<Pokemons>) com.ia.ebay9.gui.ApplicationPM.getPokemons();
